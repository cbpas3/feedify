...
CREATE POLICY "content_sources_anon_select"
  ON "content_sources" FOR SELECT
  USING (true);

CREATE POLICY "content_sources_anon_insert"
  ON "content_sources" FOR INSERT
  WITH CHECK (true);

CREATE POLICY "content_sources_anon_update"
...
CREATE POLICY "feed_items_anon_insert"
  ON "feed_items" FOR INSERT
  WITH CHECK (true);

CREATE POLICY "feed_items_anon_update"
